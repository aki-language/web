...
const config: Config = {
  title: 'Aki Language',
  tagline: 'Always killing it',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://aki-lang.org',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Discord',
              href: 'https://discord.gg/bDa4FuWRd9',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} The Aki Contributors. Built with Docusaurus.`,
    },
    prism: {
